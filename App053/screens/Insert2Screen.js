...
export default class Insert2Screen extends React.Component{
  ...
  render(){
    ...
    return(
      ...
      <SafeAreaView style={{ marginTop: 50 }}>
          ...
          <Text style={styles.welcome}>Nova Reclamação - Ruas</Text>
          <Formik
              ...
              <React.Fragment>
               ...
               {/*  <View style={{ marginHorizontal: 20, marginVertical: 5 }}>
                  ...
                  <Picker
                    ...
                    <Picker.Item label="Ciclovias" value="Ciclovias" />
                    <Picker.Item label="Entulhos ou galhadas sem coleta" value="Entulhos ou galhadas sem coleta" />
                    <Picker.Item label="Faixa de pedestres" value="Faixa de pedestres" />
                    <Picker.Item label="Linhas de ônibus" value="Linhas de ônibus" />
                    <Picker.Item label="Lombadas" value="Lombadas" />
                    <Picker.Item label="Semáforo" value="Semáforo" />
